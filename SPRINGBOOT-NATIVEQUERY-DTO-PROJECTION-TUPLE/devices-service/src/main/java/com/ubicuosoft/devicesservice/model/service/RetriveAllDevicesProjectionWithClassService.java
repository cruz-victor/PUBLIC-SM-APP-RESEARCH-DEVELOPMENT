...
import com.ubicuosoft.devicesservice.model.dto.projection.TotalMetersGroupedByStateDto;
...
@Service
public class RetriveAllDevicesProjectionWithClassService {
    private final DeviceRepository deviceRepository;

    public void execute() {
        System.out.println("RetriveAllDevicesProjectionWithClassService.execute");
        ...
        List<TotalMetersGroupedByStateProjection> listProjecitons= new ArrayList<>();
        listProjecitons.add(result.get());
        listProjecitons.add(result.get());
        listProjecitons.add(result.get());
        listProjecitons.add(result.get());
        listProjecitons.add(result.get());

        listProjecitons.add(new TotalMetersGroupedByStateDto("hola",1,2,3));

        System.out.println("total list == "+listProjecitons.size());
    }
